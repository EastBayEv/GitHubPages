...
* 11:00-12:00 PM - Launch SQLite3 and learn to wrangle data with SELECT, FROM, WHERE, GROUP BY, and ORDER BY.

* 12:00-1:00 PM - Lunch

* 1:00-2:00 PM - Build a Git repository to control version tracking with git clone, add, commit, push, and pull.
